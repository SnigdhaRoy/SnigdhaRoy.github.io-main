...
(function($) {
	...
	const textArray = ["a high school student in New York.", "the CEO of Greening Forward.", "writing a book about coding journeys.", "currently curious about AI.", "interested in meeting you! :) "];
